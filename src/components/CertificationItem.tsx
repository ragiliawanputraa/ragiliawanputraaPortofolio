...
const CertificationItem: React.FC<CertificationItemProps> = ({ certification, isCompact = false }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-900/50 dark:backdrop-blur-sm rounded-xl shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-gray-200 dark:border-gray-800 hover:border-amber-500/50 dark:hover:border-amber-400/30 animate-fade-in-up overflow-hidden">
      {/* Certification Image */}
      {certification.image && (
